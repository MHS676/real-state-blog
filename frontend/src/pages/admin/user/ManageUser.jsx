...
import { useDeleteUserMutation, useGetUserQuery } from '../../../redux/feature/auth/authApi';
...
const handleCloseModal = () => {
  ...
  return (
    <>
      ...
      {
        isModalOpen && <UpdateUserModel onClose={handleCloseModal} user={selectedUser} onRoleUpdate = {refetch}/>
      }
    </>
  )
}

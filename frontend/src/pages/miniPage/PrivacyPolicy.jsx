  ...
  return (
    <div className="container mx-auto px-6 lg:px-8 py-16">
      ...
      <ul className="list-disc list-inside text-gray-600 mb-4">
        <li>Personal Information: such as your name, email address, postal address, phone number, etc.</li>
        <li>Payment Information: including credit card numbers or other payment methods.</li>
        <li>Usage Data: details about your visits to our Site and the resources you access.</li>
      </ul>
